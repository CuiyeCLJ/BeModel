...
public class MessageChatAdapter extends BaseListAdapter<BmobMsg> {
    ...
    public MessageChatAdapter(List<BmobMsg> list, Context mContext) {
        super(list, mContext);
        currentObjectId = BmobUserManager.getInstance(mContext).getCurrentUserObjectId();
    ...
    private View createViewByType(BmobMsg message, int position) {
        ...
        if (type == BmobConfig.TYPE_IMAGE) {            //图片类型
            return getItemViewType(position) == TYPE_RECEIVER_IMAGE ? mInflater.inflate(R.layout.item_chat_received_image, null) : mInflater.inflate(R.layout.item_chat_send_image, null);
        } else if (type == BmobConfig.TYPE_LOCATION) {  //位置类型
            return getItemViewType(position) == TYPE_RECEIVER_LOCATION ? mInflater.inflate(R.layout.item_chat_received_location, null) : mInflater.inflate(R.layout.item_chat_send_location, null);
        } else if (type == BmobConfig.TYPE_VOICE) {     //语音类型
            return getItemViewType(position) == TYPE_RECEIVER_VOICE ? mInflater.inflate(R.layout.item_chat_received_voice, null) : mInflater.inflate(R.layout.item_chat_send_voice, null);
        } else {                                        //文本类型
            return getItemViewType(position) == TYPE_RECEIVER_TXT ? mInflater.inflate(R.layout.item_chat_received_message, null) : mInflater.inflate(R.layout.item_chat_send_message, null);
        }
    }
